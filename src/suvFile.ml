...
let export path dict g =
  ...
  (* Write in this file. *)
  Printf.fprintf ff "digraph {\n";
  Printf.fprintf ff "    graph[pad=0.5,nodesep=1,ranksep=2,rankdir=LR,splines=false];\n";
  Printf.fprintf ff "    node[fontname=\"Helvetica,Arial,sans-serif\",shape=box];\n";
